...
partial_order_matrices_proposers_12 = partial_orders.construct_partial_order_matrices(proposers_preferences_1,
...
print(f"Optimal stable matching for the receivers in compound instance (n,n):")
